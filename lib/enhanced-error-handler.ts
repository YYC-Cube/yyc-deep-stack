...
export function createUserFriendlyError(
  ...
  const errorTemplate = USER_FRIENDLY_ERRORS[errorType] || USER_FRIENDLY_ERRORS[ErrorType.UNKNOWN_ERROR]
 ...
 * 增强的API错误处理
 */
export function handleApiError(service: string, error: any): { status: number; body: Record<string, any> } {
  // 确定错误类型
